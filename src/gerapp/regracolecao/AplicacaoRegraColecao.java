...
public abstract class AplicacaoRegraColecao   { 
	...
	public  List ListaCorrente( DaoConexao conexao )  throws  DaoException{
     ...
     AplicacaoFiltro filtroWork = getFiltro();
      ...
      {
      saida = dao.ListaNaoRelacionadaEmEntidadeLista (filtroWork.getCodigoEntidadeEmEntidadeLista ());
		return saida;
      }
	...
	public  AplicacaoFiltro getFiltro() {
		if (_filtro==null) _filtro = new AplicacaoFiltro();
		return _filtro;
	}
  ...
  private AplicacaoFiltro[] _listaEntrada;
	...
	public abstract Aplicacao MontaAplicacao( DaoConexao conexao )  throws  DaoException;
	...
	public  Aplicacao obtemPorChave( long chave  ,  DaoConexao conexao )  throws  DaoException{
     AplicacaoDao dao = getDao();
		dao.setConexao(conexao);
